...
const Habilidades = () => {
    return (
            <aside id='container_Habilidades'>
                ...
                <div className='habilidades--Logo css'><a href="."><i className="fa-brands fa-css3-alt"></i></a></div>
                <div className='habilidades--Logo boot'><a href="."><i className="fa-brands fa-bootstrap"></i></a></div>
                <div className='habilidades--Logo node'><a href="."><i className="fa-brands fa-node-js"></i></a></div>
