...
import portfolio from '../imagenes/porfolioSoley.png';
...
export const dataProject = [
    ...
    {
        title: "Fauna Urbana",
        description: "Organización benéfica dedicada al rescate de perros en situación de calle y abandono. Dicha Website se donara a la organizacion.",
        img: faunaUrbana,
    ...
    {
        title: "Portafolio",
        description: "Desarrollo de portafolio para Soley Flores diseñadora UX/UI (responsive en proceso) ",
        img: portfolio,
        site: 'https://porfolio-soley-flores.vercel.app/',
        code: 'https://github.com/samu1992/porfolio-soley-flores',
        tech: '#Tailwind #React #TypeScript #Next'
    },
    {
        title: "Reclama Smart",
        description: "Proyecto en colaboracion con el equi de FooTalent para un estudio juridico",
        img: reclama,
        site: 'https://reclama-smart.vercel.app/',
